...
// for display purposes
      ...
      git 'https://github.com/jyotirmaya24/hello-world-servlet.git'
...
post {
        success {
            mail to:"jyotirmaya24@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"jyotirmaya24@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
